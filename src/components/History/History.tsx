...
export function History() {
  ...
  const workEvents = [
    {
      title: "Server at The Daily Catch",
    ...
    {
      title: "Server at Maggiano's",
      location: "Maggiano's",
      date: "2022.04 - 2022.07",
      description: "Worked quickly, communicated with other staff and always looked for better ways of completing tasks to improve productivity and keep tables ready for incoming guests.",
    },
    {
      title: "Food Runner/Seafood Prep at The Atlantic Seafood and Chophouse",
    ...
    {
      title: "Bellhop and Night Auditor at The Harborside Inn",
    ...
    {
      title: "Expeditor/Busser at Chianti Il Ristorante",
    ...
    {
      title: "Food Runner at Adelphi Hospitality",
    ...
    {
      title: "Busser at Fish On 30 Lake",
  ...
  const educationEvents = [
    ...
    {
      title: "Study Abroad in International Relations",
    ...
    {
      title: "Study Abroad in French Language, History, And Culture",
    ...
    {
      title: "Teacher's Assistant in Jasmine Tang's Chinese Language Class",
      location: "SUNY Geneseo",
    ...
    },
    {
      ...
      location: "Hudson Valley Community College: P-Tech Hudson Valley, NY",
    ...
    {
      title: "Attended Saratoga Springs High School",
      location: "Saratoga Springs High School, NY",
      date: "2015.09 - 2019.06",
