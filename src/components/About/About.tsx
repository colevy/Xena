    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.3 * 1000}>
          <p>
            I also studied at The Sorbonne University in Paris, France, where I immersed myself in a new environment and honed my intercultural communication skills.
          </p>
        </ScrollAnimation>
